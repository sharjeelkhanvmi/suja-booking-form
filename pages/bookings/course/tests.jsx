          ...
          <Form>
            ...
            <div className="mt-[0px] lg:w-[calc(100vw-360px)] flex justify-center items-top md:px-7 px-0 md:py-8 py-5">
                  ...
                  <div className="w-full lg:max-w-[750px]">
                    <div className="w-full mb-5 pr-4">
                      ...
                      <p className="text-current	font-regular text-[17px] mt-2">
                        ...
                        and we'll do all the admin! Your last lesson will be directly before your practical test.
                      </p>
                    ...
                    <div className="w-full flex items-center py-4 items-center">
                      <div className="pr-5">
                        <svg width="30" height="30" viewBox="0 0 52 73" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fillRule="evenodd" clipRule="evenodd" d="M51 36.5C51 50.307 39.807 61.5 26 61.5C12.193 61.5 1 50.307 1 36.5C1 22.693 12.193 11.5 26 11.5C39.807 11.5 51 22.693 51 36.5Z" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M16 71.5H36" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M26 26.5V16.5" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M31 1.5H21" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M26 11.5V1.5" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M26 56.5V46.5" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M36 36.5H46" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M6 36.5H16" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M18.9289 29.4289L11.8579 22.3579" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M40.1421 50.6421L33.0711 43.5711" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M33.0711 29.4289L40.1421 22.3579" stroke="currentColor" strokeWidth="2"></path>
                          <path d="M11.8579 50.6421L18.9289 43.5711" stroke="currentColor" strokeWidth="2"></path>
                        </svg>
                      </div>
                      <div>
               ...
               */}
                ...
                <div className="w-full mb-5 pr-4">
                  <h1 className=" text-[21px] leading-snug font-semibold">Theory Test</h1>
                  <p className=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] mt-2">At the start of your journey? Get off to
                    a flying start and pass ASAP with a fast-tracked theory test.
                  </p>
                </div>
                <div className=" mb-10">
                  <div className="mb-5">
                    ...
                    />
                    <label htmlFor="fast_track_theory" className="border cursor-pointer flex focus-visible:ring-2 py-5 font-semibold hover:bg-opacity-50 hover:bg-pmfLightGreen items-center outline-none pl-5 pr-3.5 rounded-lg text-left text-secondary transition-all w-full justify-between mb-5">
                      <div className="flex items-center">
                        <div className="pr-5 false">
                          <svg width="30" height="30" viewBox="0 0 52 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M43 31.25L28 20V42.5L43 31.25Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
                            <path fillRule="evenodd" clipRule="evenodd" d="M28 31.25L13 20V42.5L28 31.25Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
                            <path d="M1 11.5H51" stroke="currentColor" strokeWidth="2"></path>
                            <path d="M1 51.5H51" stroke="currentColor" strokeWidth="2"></path>
                            <path fillRule="evenodd" clipRule="evenodd" d="M1 61H51V1H1V61Z" stroke="currentColor" strokeWidth="2"></path>
                          </svg>
                        </div>
                        <div className="">
                          <div className=" false">
                      ...
                      <div className="fast_track_theory_bottom">
                        <div className="mb-3">
                          ...
                          <label htmlFor="i_have_already_booked" className="border cursor-pointer flex focus-visible:ring-2 py-5 font-semibold hover:bg-opacity-50 hover:bg-pmfLightGreen items-center outline-none pl-5 pr-3.5 rounded-lg text-left text-secondary transition-all w-full justify-between">
                            <div className="flex items-center">
                              ...
                              <div className="">
                                <div className=" false"> I've already booked/am booking myself</div>
                              </div>
                            </div>
                          </label>
                        </div>
                        <div className="py-4">
                          ...
                          <label htmlFor="i_have_already_passed" className="border cursor-pointer flex focus-visible:ring-2 py-5 font-semibold hover:bg-opacity-50 hover:bg-pmfLightGreen items-center outline-none pl-5 pr-3.5 rounded-lg text-left text-secondary transition-all w-full justify-between">
                            <div className="flex items-center">
                              <div className="pr-5 false">
                                <svg width="19" height="19" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
