...
const tests = () => {
  ...
  return (
    <div>
      ...
      <div class="w-full mb-5 pr-4"><h1 class="text-[26px] text-neutral-950	 pb-3 font-bold">
      ...
      <p class="text-neutral-400	 font-medium text-[17px] mt-2">
...
<div class=" mb-10">
<div class="w-full flex items-center text-left bg-pmfLightGreen ring-2 ring-primary ring-offset-1 pl-5 
pr-3.5 rounded-lg border font-semibold text-secondary cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary
 focus-visible:ring-offset-1 hover:bg-pmfLightGreen hover:bg-opacity-50 transition-all  ">
 <input type="checkbox" name="" className="sr-only" id="fast_track_practical" />

 <label  htmlFor="fast_track_practical" class=" w-full flex justify-between py-4 items-center"><div class="flex items-center"><div class="pr-5 false">
 <svg width="30" height="30" viewBox="0 0 52 73" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M51 36.5C51 50.307 39.807 61.5 26 61.5C12.193 61.5 1 50.307 1 36.5C1 22.693 12.193 11.5 26 11.5C39.807 11.5 51 22.693 51 36.5Z" stroke="currentColor" stroke-width="2"></path><path d="M16 71.5H36" stroke="currentColor" stroke-width="2"></path><path d="M26 26.5V16.5" stroke="currentColor" stroke-width="2"></path><path d="M31 1.5H21" stroke="currentColor" stroke-width="2"></path><path d="M26 11.5V1.5" stroke="currentColor" stroke-width="2"></path><path d="M26 56.5V46.5" stroke="currentColor" stroke-width="2"></path><path d="M36 36.5H46" stroke="currentColor" stroke-width="2"></path><path d="M6 36.5H16" stroke="currentColor" stroke-width="2"></path><path d="M18.9289 29.4289L11.8579 22.3579" stroke="currentColor" stroke-width="2"></path><path d="M40.1421 50.6421L33.0711 43.5711" stroke="currentColor" stroke-width="2"></path><path d="M33.0711 29.4289L40.1421 22.3579" stroke="currentColor" stroke-width="2"></path><path d="M11.8579 50.6421L18.9289 43.5711" stroke="currentColor" stroke-width="2"></path></svg>
 </div><div class=""><div class=" false"><div><p>Fast-Track Practical</p>
 <div class="mt-1 bg-gray-900 text-white  w-max py-1 px-3 font-semibold  text-xs rounded-full">ADD
 </div>
 </div>
 </div>
 </div>
 </div>
 <div class="pl-7 w-auto"><span class="text-sm flex">£110</span>
 </div>
 </label>
 </div>

 <div class=" overflow-y-hidden"><div class="mt-4 p-5 bg-white w-full rounded-lg border-2 border-primary">
 <p class="font-semibold text-[18px]">Timeline to Pass</p>
 <p class="font-regulartext-[16px] mt-2">
 ...
 <p class="font-regular text-[16px] mt-2">
 Don't want to pass ASAP? Let us know your preferred practical test date below. </p>
 <button class="w-full bg-pmfGray border-gray-300 text-secondary hover:bg-pmfGraySecondary focus:bg-pmfGraySecondary flex border
 ...
 <span class="flex items-center">Set your preferred date</span>
 </button>
 </div>
 </div>
 </div>

<div class="w-full mb-5 pr-4"><h1 class=" text-[21px] leading-snug font-semibold">Theory Test</h1>
<p class=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] mt-2">At the start of your journey? Get off to 
a flying start and pass ASAP with a fast-tracked theory test.</p></div>
<div class=" mb-10">
<div class="w-full flex items-center text-left  bg-pmfGray py-4 pl-5 pr-3.5 rounded-lg border font-semibold
 text-secondary cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1
  ...
  <input type="checkbox" name="" className="sr-only" id="fast_track_theory" />
  <label htmlFor="fast_track_theory" class="w-full flex justify-between items-center">
  <div class="flex items-center"><div class="pr-5 false">
  <svg width="30" height="30" viewBox="0 0 52 62" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M43 31.25L28 20V42.5L43 31.25Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M28 31.25L13 20V42.5L28 31.25Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path><path d="M1 11.5H51" stroke="currentColor" stroke-width="2"></path><path d="M1 51.5H51" stroke="currentColor" stroke-width="2"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M1 61H51V1H1V61Z" stroke="currentColor" stroke-width="2"></path></svg>
  </div><div class=""><div class=" false"><div><p>Fast-Track Theory</p>
  <div class="mt-1 bg-gray-900 text-white  w-max py-1 px-3 font-semibold  text-xs rounded-full">ADD</div></div></div>
  </div></div><div class="pl-7 w-auto"><span class="text-sm text-black flex">£40</span>
  </div>
  ...
  <div class="mb-5">
  <div>
  <div class="w-full flex items-center text-left  bg-pmfGray py-4 px-5 rounded-lg border font-semibold text-secondary 
  cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1 hover:bg-pmfLightGreen
   ...
   <div class="w-full flex items-center text-left  bg-pmfGray py-4 px-5 rounded-lg border font-semibold text-secondary
    ...
    <input type="checkbox" name="" className="sr-only" id="i_have_already_passed" />
    <label htmlFor="i_have_already_passed" class=" w-full flex justify-between items-center">
    <div class="flex items-center">
    <div class="pr-5 false"><svg width="19" height="19" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class=""><div class=" false">I've already passed</div></div>
    </div>
    </label>
    </div>
    </div>
