...
<Form>
   ...
   <div className=" mt-[80px] items-top px-7 py-8">
         ...
         <div className="grid grid-cols-2 gap-4">
            <div>
               <input
                  ...
                  id="manual"
                  value="manual"
                  onChange={(e) => setIsOpen(isOpen => true)}
               //onChange={(e) => handleRadioChange(e, formikProps)}
               />
               <label for="manual" className="w-full flex items-center text-left  bg-emerald-100	py-4 px-5 rounded-lg border font-semibold text-secondary cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1 hover:bg-pmfLightGreen hover:bg-opacity-50 transition-all  ">
      ...
      <div className=" mb-10">
         <button
            className="w-full flex items-center text-left  bg-pmfGray py-4 px-5 rounded-lg border font-semibold 
         ...
         <button
            className="w-full flex items-center text-left  bg-pmfGray py-4 pl-5 pr-3.5 rounded-lg border font-semibold
            text-secondary cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1
            hover:bg-pmfLightGreen hover:bg-opacity-50 transition-all mb-3 "
            >
            <div className=" w-full flex justify-between items-center">
      ...
      <div className="mb-8 p-5 bg-white w-full rounded-lg border-2 border-secondary">
         <p classname=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] ">
            It's always best to book a few extra hours to make sure you're test ready.
            If you've had 10 to 15 hours of driving lessons in the past, a 30 to
            40-hour course would be perfect to bring your total to the 45 hours
            recommended by the DVSA.
            <br />
            <br />
            Bear in mind that 2-3 hours of every course are reserved for the practical
            test and preparation beforehand.
         </p>
      </div>
   </div>
   <div className=" mb-10">
   <div className="">
   <div className="mb-7">
   <div className="relative w-full p-2 -z-10 rounded-lg text-center capitalize text-secondary font-semibold bg-lime-300 mb-4 text-sm">
      Regular Courses
