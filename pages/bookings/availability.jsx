...
<h1 class="text-[21px] leading-snug font-semibold">Nearly there, alex! <br /> How fast do you want your course?</h1>
<div class="cursor-pointer">
<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor"
 stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" 
 y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
</div></div>
</div>
<div class=" overflow-y-hidden">
<div class="mb-8 p-5 bg-white w-full rounded-lg border-2 border-secondary">
<p class=" text-secondary leading-snug text-opacity-70 font-regular text-[15px] ">
...
slower and spread your lessons over a longer time. If you would like an intensive course, you’ll need to have good availability
 during the day for lessons.</p>
 </div></div>

<div class="mb-10">
<div>
<div class="w-full flex items-center text-left py-4 px-5 rounded-lg border font-semibold text-secondary cursor-pointer
 outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-indigo-400  
 transition-all mb-5 ">
 <div class=" w-full flex justify-between items-center">
 <input type="radio" name="intensive" className="sr-only" id="intensive" />
 <label htmlFor="intensive" class="flex items-center">
 <div class="pr-5 false">
 <svg width="24" height="24" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
 <path d="M12.362 4.214C14.0869 4.98477 15.495 6.32406 16.3512 8.00814C17.2074 9.69222 17.4599 11.6191 17.0663 13.4669C16.6728 15.3147 15.6571 16.9715 14.189 18.1606C12.7209 19.3496 10.8892 19.9989 9 20C7.38401 19.9999 5.80363 19.5253 4.45502 18.6349C3.10642 17.7446 2.04898 16.4778 1.41398 14.9918C0.778983 13.5058 0.59438 11.8661 0.88309 10.2761C1.1718 8.68608 1.92111 7.21589 3.038 6.048C3.80766 7.12273 4.82326 7.99775 6 8.6C6.02061 7.27863 6.33252 5.97808 6.91348 4.79109C7.49444 3.6041 8.33015 2.55992 9.361 1.733C10.1477 2.78819 11.1767 3.63876 12.361 4.213L12.362 4.214Z" fill="#FFB800" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 17C9.95138 16.9996 10.8671 16.6377 11.5616 15.9875C12.2561 15.3372 12.6775 14.4473 12.7404 13.498C12.8033 12.5488 12.5031 11.611 11.9005 10.8748C11.2979 10.1386 10.438 9.65894 9.495 9.533C8.46257 10.4568 7.78229 11.71 7.57 13.079C6.79967 12.8905 6.07458 12.5506 5.437 12.079C5.25185 12.6423 5.20291 13.2414 5.29418 13.8273C5.38545 14.4131 5.61434 14.969 5.96206 15.4492C6.30978 15.9295 6.76642 16.3204 7.29451 16.59C7.8226 16.8596 8.40708 17.0001 9 17V17Z" fill="#F15937" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
 </div>
 <div class=""><span class="w-full">Intensive</span>
 <div class="text-secondary text-opacity-[0.65] text-sm false">
 <p class=" text-secondary leading-snug text-opacity-70 font-medium 
 ...
 complete a 10-hour course in a week, and one of our longest courses in around a month.</p></div>
 </div>
 </label>
 </div>
 </div>
 ...
 <input type="radio" name="semi-intensive" className="sr-only" id="semi_intensive" />
 <label htmlFor="semi-intensive" class="w-full flex justify-between items-center">
 <div class="flex items-center">
 <div class="pr-5 false">
 <svg width="24" height="24" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.75 12.5L11.25 1.25L9 9.5H17.25L6.75 20.75L9 12.5H0.75Z" fill="#ADFF00" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
 </div><div class="">
 <span class="w-full">Semi-Intensive</span><div class="text-secondary text-opacity-[0.65] text-sm false">
 <p class=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] mt-2">The best of both worlds.
  Fast shouldn't mean inflexible, so we invented the semi-intensive driving course.
   An example of a semi-intensive course is having two or three 2-hour lessons a week.</p>
   </div>
   </div>
   </div>
   </label>
   ...
   <input type="radio" name="relaxed" className="sr-only" id="relaxed" />
   <label htmlFor="relaxed" class=" w-full flex justify-between items-center">
   ...
   <div class="">
   <span class="w-full">Relaxed</span>
   <div class="text-secondary text-opacity-[0.65] text-sm false">
   <p class=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] mt-2">
   Have a more laidback outlook on life? This course structure will take you a little longer to pass than our intensive 
   structures, but you get to set the pace. An example of a relaxed course would be one or two 2-hour lessons a week.</p></div>
   </div>
   </div>
   </label>
   </div>
