...
<div class="w-full flex items-center text-left py-4 px-5 rounded-lg border font-semibold text-secondary cursor-pointer
 ...
 transition-all mb-5 "><div class=" w-full flex justify-between items-center">
 <input type="radiobutton" name="" className="sr-only" id="intensive" />
 ...
 </div><div class=""><span class="w-full">Intensive</span>
 <div class="text-secondary text-opacity-[0.65] text-sm false"><p class=" text-secondary leading-snug text-opacity-70 font-medium 
 ...
 complete a 10-hour course in a week, and one of our longest courses in around a month.</p></div></div>
 </div></div>
 </div>
 ...
 <input type="radiobutton" name="" className="sr-only" id="semi_intensive" />
 ...
 <p class=" text-secondary leading-snug text-opacity-70 font-medium text-[15px] mt-2">The best of both worlds.
  Fast shouldn't mean inflexible, so we invented the semi-intensive driving course.
   An example of a semi-intensive course is having two or three 2-hour lessons a week.</p></div></div></div>
   </div>
   </div>
   ...
   <input type="radiobutton" name="" className="sr-only" id="relaxed" />
   <div class=" w-full flex justify-between items-center">
   ...
   </div><div class=""><span class="w-full">Relaxed</span>
