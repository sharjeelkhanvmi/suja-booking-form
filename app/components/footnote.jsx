...
const Footnote = () => {
  ...
  return (
   <motion.div
                  ...
                  className={`my-4 w-full text-sm font-semibold opacity-60 text-center ${router.pathname !== "/bookings" && router.pathname !== "/bookings/payment" && router.pathname !== "/bookings/thankyou" ? "lg:w-[calc(100vw-360px)]" : ""}`}
                  >
