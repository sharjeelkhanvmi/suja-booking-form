  ...
  return (
    ...
    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
      <button
        ...
        className="w-full flex items-center text-left bg-pmfGray py-4 px-5 rounded-lg font-semibold text-secondary cursor-pointer
       outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-1 bg-gray-200 hover:bg-gray-300 hover:bg-opacity-50 transition-all font-semibold w-full bg-opacity-30 border-transparent px-0 cursor-pointer hover:bg-opacity-50 hover:bg-slate-200 group"
        id="toggleButton"
      >
        ...
        <div className="mx-4">
          ...
          {openState["button1"] && (
            <p
              ...
              id="detail-paragraph"
            >
              We're certain that we can help you pass fast. You'll get all your
              money back if we can't fast-track your test within 30 days of
              booking or connect you with an instructor in time for your course.
            </p>
          )}
        </div>
      </button>
