          ...
          <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
            ...
            <div class="flex-auto">
              <a href="#" class="block font-semibold text-gray-900">
                Learn from the best <span class="absolute inset-0"></span>
              </a>
            </div>
          </div>
          <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
            ...
            <div class="flex-auto">
              <a href="#" class="block font-semibold text-gray-900">
                Support at every step <span class="absolute inset-0"></span>
              </a>
            </div>
          </div>
          <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
            ...
            <div class="flex-auto">
              <a href="#" class="block font-semibold text-gray-900">
                100% Money Back Guarantee <span class="absolute inset-0"></span>
              </a>
            </div>
          </div>
        </div>
